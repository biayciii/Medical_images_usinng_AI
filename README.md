...
![Proposed Architecture](images/CT-Trang1.drawio.png)

### Baseline Single-Channel U-Net (For Comparison)
![Baseline U-Net](images/baseline_Unet.drawio (1).png)
...
![Segmentation Visual Results](images/case_12_slice_100.png)
